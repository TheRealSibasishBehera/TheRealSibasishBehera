...
- [WIP: Add extproc translation in the agentgateway traffic policy plugin](https://github.com/kgateway-dev/kgateway/pull/12667) on [kgateway-dev/kgateway](https://github.com/kgateway-dev/kgateway) (today)
