...
- [rivet-dev/agentos](https://github.com/rivet-dev/agentos) - Give agents an operating system as a library. Runs in your existing backend – no sandboxes, VMs, or SaaS. Powered by WebAssembly &amp; V8 isolates. (5 days ago)
- [penberg/chimera](https://github.com/penberg/chimera) - Sandbox untrusted code with safe access to the host. (5 days ago)
