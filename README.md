...
- [containers/conmon-rs](https://github.com/containers/conmon-rs) - An OCI container runtime monitor. (5 days ago)
- [youki-dev/youki](https://github.com/youki-dev/youki) - A container runtime written in Rust (5 days ago)
- [skarnet/s6](https://github.com/skarnet/s6) - The s6 supervision suite.   (5 days ago)
- [redpanda-data/connect](https://github.com/redpanda-data/connect) - Fancy stream processing made operationally mundane (5 days ago)
...
- [kubernetes-sigs/e2e-framework](https://github.com/kubernetes-sigs/e2e-framework) - A Go framework for end-to-end testing of components running in Kubernetes clusters. (3 weeks ago)

#### 👷 Check out what I'm currently working on

- [iris-xyz/corrosion-dns](https://github.com/iris-xyz/corrosion-dns) - An authoritative DNS server backed by Corrosion  (1 week ago)
- [iris-xyz/depot-kvm-test](https://github.com/iris-xyz/depot-kvm-test) - Testing KVM support on Depot GitHub Actions runners (2 weeks ago)
